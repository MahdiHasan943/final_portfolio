            ...
            >
              <div className="px-4 sm:px-8 bg-[#f2f2f2]   z-[100000]  absolute top-0 lg:px-20  pt-20 pb-10">
                ...
                <div className="grid grid-cols-4 sm:pt-8  gap-4">
                  ...
                  <p className="absolute text-center font-semibold  text-[14px] py-4 font-popping text-[#202128]   ease-in-out duration-300 top-[90px] group-hover:top-[40px] sm:group-hover:top-[60px]">React.js</p>
                  </div>
                  <div className="group relative pb-10  overflow-hidden">
                  ...
                  >
                    ...
                    <p className="absolute text-center font-semibold  text-[14px] py-4 font-popping text-[#202128]   ease-in-out duration-300 top-[90px] group-hover:top-[40px] sm:group-hover:top-[60px]">UI/UX</p>
                  ...
                  >
                    ...
                    <p className="absolute text-center font-semibold  text-[14px] py-4 font-popping text-[#202128]   ease-in-out duration-300 top-[90px] group-hover:top-[40px] sm:group-hover:top-[60px]">is Fun.</p>
                  ...
                  >
                    ...
                    <p className="absolute text-center font-semibold  text-[14px] py-4 font-popping text-[#202128]   ease-in-out duration-300 top-[90px] group-hover:top-[40px] sm:group-hover:top-[60px]">Semicolons.</p>
