    ...
    <section className="">
      ...
      <div className='relative h-full bg-white'>
        <motion.div
           ...
           animate={controls}
           variants={variants}
          className="absolute top-0 left-0 bg-[#1f4c8f] h-full w-full"></motion.div>
        ...
        >
          ...
          <div className="absolute h-[400px] sm:h-[450px] w-full z-50 top-0 left-0">
            <div className="flex w-full h-full justify-center items-center">
              <div className="  w-[250px] group-hover:w-[280px] group-hover:h-[280px] ease-in-out duration-200  h-[250px] bg-center bg-cover rounded-full" style={{backgroundImage: 'url(/images/codepen-loader.gif)'}}>
