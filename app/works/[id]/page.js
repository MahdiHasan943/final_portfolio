      ...
      >
        ...
        <div className="absolute px-4 top-0 left-0 w-full h-full flex justify-center items-end">
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-3 w-full text-center py-10">
            ...
            >
              {" "}
              ROLE <span className="px-2 text-white">
                FRONT-END DEVELOPER
              </span>{" "}
            </motion.p>
            <motion.p
            ...
            >
              {" "}
              CONTEXT <span className="px-2 text-white">
                WEBSITE REDESIGN
              </span>{" "}
            </motion.p>
            <motion.p
            ...
            >
              {" "}
              PERIOD <span className="px-2 text-white">MIDDLE 2020</span>{" "}
            </motion.p>
          </div>
        </div>
      </div>
          ...
          <div className="mx-auto py-4 sm:flex  justify-center  gap-10">
            <div className="">
              ...
              >
                {" "}
                As the{" "}
                <span className="text-[#37a5eb]">Front-end Developer</span>, I
                was responsible of building the entire UI for the new website,
                redefining the User Experience and studying new interactions
                between the User and the Interface. One of the most exciting
                experience was integrating the entire front-end system with the{" "}
